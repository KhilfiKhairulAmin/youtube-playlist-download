...
# Ensure temp folder and all its content is deleted before test
cleanup_folder()
...
def test_video_download():
  ...
  result = runner.invoke(app, ["download", VIDEO_LINK, FOLDER])
...
def test_playlist_download():
  ...
  result = runner.invoke(app, ["download", PLAYLIST_LINK, FOLDER])
...
def test_mix_download():
  ...
  result = runner.invoke(app, ["download-mix", MIX_HTML_PATH, FOLDER])
